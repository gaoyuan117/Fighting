...
//                int[] optionsCurrentItems=wheelOptions.getCurrentItems();
            	ArrayList<Integer> optionsCurrentItems = wheelOptions.getCurrentItems();
                optionsSelectListener.onOptionsSelect(optionsCurrentItems.get(0), 
                		optionsCurrentItems.size()>1 ? optionsCurrentItems.get(1) : null,
                				optionsCurrentItems.size()>2 ? optionsCurrentItems.get(2) : null);
            }
            dismiss();
            return;
        }
