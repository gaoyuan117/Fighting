...
import com.xiangying.fighting.utils.NavigationBarUtil;

import butterknife.Bind;
import butterknife.ButterKnife;

/**
 * Created by Koterwong on 2016/10/27 15:57
 */
public class ShareView {
  ...
  private void initShareView(Activity activity) {
    fullMaskView = View.inflate(activity, R.layout.layout_view_full_mask_layout, null);
    contentLayout = LayoutInflater.from(activity).inflate(R.layout.layout_share, null);
  ...
  public void show() {
    ...
    contentLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
      ...
      public void onGlobalLayout() {
        ...
        ObjectAnimator
            .ofFloat(contentLayout, "translationY", panelHeight, -navigationBarHeight)
            .setDuration(200)
            .start();
      }
    });
  ...
  public void hide() {
    fullMaskView.setVisibility(View.GONE);
    ObjectAnimator
        .ofFloat(contentLayout, "translationY", -navigationBarHeight, panelHeight)
        .setDuration(200)
        .start();
  }
