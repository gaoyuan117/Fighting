package com.xiangying.fighting.ui.chat.help;
...
import com.xiangying.fighting.ui.chat.db.DemoDBManager;
import com.xiangying.fighting.ui.chat.db.InviteMessgeDao;
import com.xiangying.fighting.ui.chat.parse.UserProfileManager;
import com.xiangying.fighting.ui.chat.util.Constant;
import com.xiangying.fighting.ui.chat.videocall.CallReceiver;
import com.xiangying.fighting.ui.chat.videocall.VideoCallActivity;
import com.xiangying.fighting.ui.chat.wigdet.EmojiconExampleGroupData;
import com.xiangying.fighting.ui.chat.wigdet.InviteMessage;
import com.xiangying.fighting.ui.chat.wigdet.RobotUser;
import com.xiangying.fighting.ui.chat.wigdet.UserDao;
import com.xiangying.fighting.ui.first.ApplyFriendActivity;
  ...
  protected void setEaseUIProviders() {
    ...
    easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
      ...
      public Intent getLaunchIntent(EMMessage message) {
        if (message.getType() == Type.CMD) {//透传消息
          EMCmdMessageBody cmdMsgBody = (EMCmdMessageBody) message.getBody();
          String aciton = cmdMsgBody.action();//获取自定义action
          try {
            Intent intent = new Intent(appContext, ApplyFriendActivity.class);
            switch (aciton) {
              case "addFriend":
                intent.putExtra("username", message.getFrom());
                intent.putExtra("fid", message.getStringAttribute("fid"));
                break;
            }
            return intent;
        ...
        // you can set what mActivity you want display when user click the notification
        Intent intent = new Intent(appContext, ChatActivity.class);
        // open calling mActivity if there is call
        if (isVideoCalling) {
...
//                    intent = new Intent(appContext, VoiceCallActivity.class);
  ...
  /***
   * 监听好友状态的Listener todo 监听联系人状态。
   */
  public class MyContactListener implements EMContactListener {

    @Override
    public void onContactAdded(String username) {
      // save contact   增加了联系人回调该方法
    ...
    public void onContactInvited(String username, String reason) {
      ...
      msg.setTime(System.currentTimeMillis());
      msg.setReason(reason);
      LogKw.d(TAG, username + "apply to be your friend,reason: " + reason);
    ...
    public void onContactAgreed(String username) {
      ...
      msg.setFrom(username);
      msg.setTime(System.currentTimeMillis());
      LogKw.d(TAG, username + "accept your request");
...
//      Log.d(username, username + " refused to your request");
      LogKw.e(TAG,username + " refused to your request");
    }
  }
  ...
  /**
   * Global listener
   * If this event already handled by an mActivity, you don't need handle it again
    ...
    messageListener = new EMMessageListener() {
      ...
      public void onCmdMessageReceived(List<EMMessage> messages) {
        for (EMMessage message : messages) {
          ...
          getNotifier().onNewNotifaMsg(message);
