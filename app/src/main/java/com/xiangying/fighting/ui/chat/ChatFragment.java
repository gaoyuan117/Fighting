...
import com.xiangying.fighting.ui.chat.activity.ContextMenuActivity;
import com.xiangying.fighting.ui.chat.activity.ForwardMessageActivity;
import com.xiangying.fighting.ui.chat.activity.GroupDetailsActivity;
import com.xiangying.fighting.ui.chat.activity.PickAtUserActivity;
import com.xiangying.fighting.ui.chat.help.DemoHelper;
import com.xiangying.fighting.ui.chat.util.ChatRowVoiceCall;
...
public class ChatFragment extends EaseChatFragment
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            titleBar.setRightImageResource(R.drawable.ic_chat_single);
        } else {
            titleBar.setRightImageResource(R.drawable.ic_chat_group);
        }
        ...
        titleBar.setRightLayoutClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (chatType == EaseConstant.CHATTYPE_SINGLE) {
                    UserTalkDetailActivity.start(getContext(), toChatUsername);
                } else {
                    GroupTalkDetailActivity.start(getContext(), toChatUsername);
...
//            inputMenu.registerExtendMenuItem(R.string.attach_voice_call, R.drawable.em_chat_voice_call_selector, ITEM_VOICE_CALL, extendMenuItemClickListener);
            inputMenu.registerExtendMenuItem(R.string.attach_video_call, R.drawable.chat_vedio, ITEM_VIDEO_CALL, extendMenuItemClickListener);
        }
        //聊天室暂时不支持红包功能
        //red packet code : 注册红包菜单选项
        if (chatType != Constant.CHATTYPE_CHATROOM) {
            inputMenu.registerExtendMenuItem(R.string.attach_red_packet, R.drawable.chat_redpack, ITEM_RED_PACKET, extendMenuItemClickListener);
        }
        //end of red packet code
    }
...
//        	startActivityForResult(new Intent(getActivity(), ChatRoomDetailsActivity.class).putExtra("roomId", toChatUsername), REQUEST_CODE_GROUP_DETAIL);
    ...
    public void onAvatarClick(String username) {
        FriendActivity.start(getActivity(), username, null);
    }
