 ...
 */
package com.xiangying.fighting.ui.chat.runtimepermissions;
...
public class PermissionsManager {
   ...
   *
   * @param activity    the mActivity necessary to request the permissions.
   ...
   * will fail to work as the mActivity reference is necessary to check for permissions.
   *
   ...
   *
   * @param activity    the mActivity to check permissions
