...
public class ShopService {
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Myshop/shopProtocol", method = Method.Post,
      encoder = WebFormEncoder.class)
  public static class ShopProtocolRequest extends Endpoint {

  }

  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Myshop/myshopInfo", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Myshop/myshopInfo", method = Method.Post,
      encoder = WebFormEncoder.class)
  public static class ShopInfoRequest2 extends Endpoint {

  }

  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/public/services", method = Method.Post,
      encoder = WebFormEncoder.class)
  public static class OnlineServiceRequest extends Endpoint {

  }

  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/LearningCenter/getList", method = Method
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/LearningCenter/getDetail", method = Method
      .Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Myshop/createShop", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Myshop/settingMyshop", method = Method.Post,
      encoder = WebFormEncoder.class)
