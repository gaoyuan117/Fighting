...
public class FavoriteService {
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/addProduct", method = Method.Post,
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/getCollectIdByProduct", method =
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/productCollectDel", method = Method
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/collectProducts", method = Method
			.Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/myBrowse", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/borwseCollectDel", method = Method
			.Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/addShop", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/getCollectIdByShop", method = Method
			.Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/shopCollectDel", method = Method
			.Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Collect/collectShops", method = Method.Post,
			encoder = WebFormEncoder.class)
