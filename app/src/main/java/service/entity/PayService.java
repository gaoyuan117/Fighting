...
public class PayService {
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Pay/pay", method = Method.Post, encoder =
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Pay/balancePay", method = Method.Post,
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Pay/recharge", method = Method.Post, encoder
			= WebFormEncoder.class)
