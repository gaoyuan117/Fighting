...
public class HelpService {
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Help/postFeedback", method = Method.Post,
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Help/articles", method = Method.Post, encoder
			= WebFormEncoder.class)
  public static class ArticlesRequest extends Endpoint {

  }

  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Help/articleDetail", method = Method.Post,
			encoder = WebFormEncoder.class)
