...
public class FileService {
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/File/uploadPicture", method = Method.Post,
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/File/uploadMovie", method = Method.Post,
      encoder = WebFormEncoder.class)
  @HttpHost(headers = {})
