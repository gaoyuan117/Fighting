...
public class DistinguishService {
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Checkup/add", method = Method.Post, encoder =
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/checkup/MyCheckupList", method = Method.Post,
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/checkup/CheckupDetail", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Checkup/delCheckup", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Checkup/Shipments", method = Method.Post,
			encoder = WebFormEncoder.class)
