...
public class MessageService {
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Message/messageList", method = Method.Post,
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Message/messageDetail", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/News/getList", method = Method.Post, encoder
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/News/getDetail", method = Method.Post,
			encoder = WebFormEncoder.class)
