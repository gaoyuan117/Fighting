...
public class CartService {
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Cart/addTocart", method = Method.Post,
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Cart/delCartbyId", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Cart/editCart", method = Method.Post, encoder
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Cart/getCarts", method = Method.Post, encoder
			= WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/cart/toTrade", method = Method.Post, encoder
			= WebFormEncoder.class)
