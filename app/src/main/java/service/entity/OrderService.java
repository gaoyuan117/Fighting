...
public class OrderService {
   ...
   * 查询订单
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/order/getmyorders", method = Method.Post,
   ...
   * 提交订单（购物车提交）
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/submitOrder", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/confirmOrder", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/cancelOrder", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/deleteOrder", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/myshop/getMyOrders", method = Method.Post,
			encoder = WebFormEncoder.class)
   ...
   * 查询订单详情(会员)
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/getOrderDetail", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/confirmProduct", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/shippingOrder", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Myshop/shipments", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/applyforReturn", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Myshop/refundOperation", method = Method
