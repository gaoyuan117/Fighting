...
public class ShippingService {
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Public/shippingList", method = Method.Post,
      encoder = WebFormEncoder.class)
  public static class ShippingListRequest extends Endpoint {

  }

  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Trace/traceDetail", method = Method.Post,
      encoder = WebFormEncoder.class)
