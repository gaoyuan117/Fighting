...
public class ProductService {
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Shop/ShopInfo", method = Method.Post, encoder
  ...
  @Deprecated
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getHots", method = Method.Post,
   ...
   * 官方公告列表
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Notice/getList", method = Method.Post,
      encoder = WebFormEncoder.class)
   ...
   * 官方公告详情
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Notice/getDetail", method = Method.Post,
      encoder = WebFormEncoder.class)
   ...
   * 获取广告
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Ad/getList", method = Method.Post, encoder =
      WebFormEncoder.class)
  ...
  public static class IndexbannerDetailRequest extends Endpoint {
    @SerializedName("id")
    public String id;
  }
...
//        public String id;
   ...
   * 首页数据
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Home/homepage", method = Method.Post, encoder
      = WebFormEncoder.class)
   ...
   * 获取分类模块
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getGroups", method = Method.Post,
      encoder = WebFormEncoder.class)
   ...
   * 获取分类列表
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getCategoryTree", method = Method
      .Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/productOption", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Shop/Products", method = Method.Post, encoder
      = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Shop/produtSearch", method = Method.Post,
      encoder = WebFormEncoder.class)
   ...
   * 获取商品
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getProducts", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getGiftCategory", method = Method
      .Post, encoder = WebFormEncoder.class)
  public static class GiftCagetoryRequest extends Endpoint {

  }

  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getProductGift", method = Method
      .Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/paipinSignup", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/bid", method = Method.Post, encoder =
      WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/bidLog", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/bidClause", method = Method.Post,
      encoder = WebFormEncoder.class)
  public static class BondNoticeRequest extends Endpoint {

  }

  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Public/search", method = Method.Post, encoder
      = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getpaipinList", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Public/getStatus", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getMyProducts", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getProduct", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getMyProduct", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/editOption", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/deleteOption", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/addOptionPrice", method = Method
      .Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/editOptionPrice", method = Method
      .Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/deleteOptionPrice", method = Method
      .Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/getPanicTimes", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/myproductPutaway", method = Method
      .Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/myproductHalt", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/myproductDel", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/addProductGift", method = Method
      .Post, encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/addProductPanic", method = Method
      .Post, encoder = WebFormEncoder.class)
   ...
   * 添加普通商品
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/add", method = Method.Post, encoder =
      WebFormEncoder.class)
   ...
   * 编辑普通商品
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Product/edit", method = Method.Post, encoder
      = WebFormEncoder.class)
