...
public class ReviewService {
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Comment/postcomment", method = Method.Post,
   ...
   * 追加评价
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Comment/moreComment", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Order/comments", method = Method.Post,
      encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Comment/getProductComment", method = Method
