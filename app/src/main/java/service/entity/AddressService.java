...
public class AddressService {
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Public/jzbAddress", method = Method.Post,
   ...
   * 获取省份列表
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Public/getProvinces", method = Method.Post,
			encoder = WebFormEncoder.class)
   ...
   * 获取城市列表
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Public/getCities", method = Method.Post,
			encoder = WebFormEncoder.class)
   ...
   * 获取区县列表
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/Public/getAreas", method = Method.Post,
			encoder = WebFormEncoder.class)
   ...
   * 获取收货地址列表
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/User/getReceiveAddrs", method = Method.Post,
			encoder = WebFormEncoder.class)
   ...
   * 删除收货地址
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/User/delReceiveAddr", method = Method.Post,
			encoder = WebFormEncoder.class)
   ...
   * 添加收货地址di
   */
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/User/addReceiveAddr", method = Method.Post,
			encoder = WebFormEncoder.class)
  ...
  @HttpPortal(path = "http://jzb.jxlnxx.com/?s=/Api/User/editReceiveAddr", method = Method.Post,
			encoder = WebFormEncoder.class)
