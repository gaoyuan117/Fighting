...
import service.api.Account;
import service.api.AppInfo;
import service.api.CommonReturn;
import service.api.Head;
import service.api.Login;
import service.api.Mobile;
import service.api.NickName;
import service.api.Sex;
import service.api.Statistics;
import service.api.VerifyCode;
...
public class AccountDao
{
	...
	public static void sendCmdQueryVersion(HttpDataLoader httpDataLoader)
	{
		...
		httpDataLoader.doPostProcess(registerRequest, Version.class);
	}
