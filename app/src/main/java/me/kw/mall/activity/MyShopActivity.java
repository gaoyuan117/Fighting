...
public class MyShopActivity extends MallBaseActivity {
    @Bind(R.id.imgvew_shop_logo_show)
    ImageView mImgvewShopLogo;
    @Bind(R.id.imgvew_signpic_show)
    ImageView mImgvewShopSignpic;
    @Bind(R.id.tvew_shopname_show)
    TextView mTvewShopname;
    @Bind(R.id.tvew_allmoeny_show)
    TextView mTvewAllmoeny;
    @Bind(R.id.tvew_visitorcount_show)
    TextView mTvewVisitorcount;
    @Bind(R.id.tvew_ordercount_show)
