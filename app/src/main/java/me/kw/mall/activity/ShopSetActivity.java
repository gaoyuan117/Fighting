...
public class ShopSetActivity extends MallBaseActivity {
  ...
  @Bind(R.id.ivew_shop_set_shopicon_show) CircleImageView mIvewShopSetShopicon;
  @Bind(R.id.ivew_shop_fitment_signboard_show) ImageView mIvewShopSetSignboardicon;
  @Bind(R.id.tvew_shop_set_shopname_show) TextView mTvewShopSetShopname;
  @Bind(R.id.tvew_shop_set_shopintroduce_show) TextView mTvewShopSetShopintroduce;
