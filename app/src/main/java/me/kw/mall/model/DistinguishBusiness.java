...
import me.kw.mall.dao.DistinguishDao;
import service.api.DistinguishItem;
import service.entity.DistinguishService;

public class DistinguishBusiness {

  public static boolean addDistinguish(Context context, HttpDataLoader httpDataLoader,
                                       DistinguishService.AddDistinguishRequest request) {
  ...
  public static boolean queryDistinguishShippment(Context context, HttpDataLoader httpDataLoader,
                                                  String distinguishId, String shippingCode,
                                                  String code,
                                                  String[] coverIds) {
