...
import me.kw.mall.dao.ProviderOrder;
...
public class ProviderOrderBusiness {
    ...
    for (int i = 0; i < orderItems.length; i++) {
      ...
      if (!TextUtils.isEmpty(orderItem.image_path)) {
        ...
        if (!TextUtils.isEmpty(orderItem.image)) {
          imageLoader.displayImage(Endpoint.HOST + orderItem.image, imgvewPhoto, options);
        }
      }
  ...
  public static void intentToExpressDetailActivity(Context context, String orderId, String
      image) {
    ComponentName cn = new ComponentName("com.android.juzbao.mActivity",
            "com.android.juzbao.mActivity.ExpressDetailActivity_");
  ...
  public static void intentToSubmitExpressActivity(Context context, String orderId) {
    ...
    ComponentName cn = new ComponentName
        ("com.android.juzbao.mActivity", "com.android.juzbao.mActivity" +
