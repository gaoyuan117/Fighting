...
import me.kw.mall.dao.ProviderProduct;
...
public class ProviderProductBusiness {
  ...
  public static void queryDelChildOption(HttpDataLoader httpDataLoader, String id) {
  ...
  public static void queryDelOptionPrice(HttpDataLoader httpDataLoader, String id) {
    ProductService.DelOptionPriceRequest request = new ProductService.DelOptionPriceRequest();
    request.Id = id;
    httpDataLoader.doPostProcess(request, CommonReturn.class);
  }

  public static boolean addProductGift(Context context, HttpDataLoader httpDataLoader,
  ...
  public static boolean addProductPainc(Context context, HttpDataLoader httpDataLoader,
  ...
  public static boolean addPutongProduct(Context context, HttpDataLoader httpDataLoader,
  ...
  public static boolean addPaipingProduct(Context context, HttpDataLoader httpDataLoader,
  ...
  public static boolean addDingzhiProduct(Context context, HttpDataLoader httpDataLoader,
  ...
  public static boolean editPutongProduct(Context context, HttpDataLoader httpDataLoader,
...
//        }
  ...
  public static boolean editPaipingProduct(Context context, HttpDataLoader httpDataLoader,
