...
import me.kw.mall.constant.Config;
import me.kw.mall.dao.AccountDao;
import service.api.CommonReturn;
import service.api.Gift;
import service.api.IsSigned;
import service.api.Statistics;
import service.api.Version;
import service.entity.AccountService;
...
public class AccountBusiness {
  ...
  public static void querySign(HttpDataLoader httpDataLoader) {
    AccountService.SignRequest signRequest = new AccountService.SignRequest();
    httpDataLoader.doPostProcess(signRequest, CommonReturn.class);
  }

  public static void queryIsSign(HttpDataLoader httpDataLoader) {
    AccountService.IsSignRequest signRequest = new AccountService.IsSignRequest();
    httpDataLoader.doPostProcess(signRequest, IsSigned.class);
  }

  public static void queryGift(HttpDataLoader httpDataLoader) {
    AccountService.GiftRequest signRequest = new AccountService.GiftRequest();
    httpDataLoader.doPostProcess(signRequest, Gift.class);
  }

  public static void queryUseGift(HttpDataLoader httpDataLoader, String shopId, String gift,
                                  String quantity) {
    AccountService.UseGiftRequest signRequest = new AccountService.UseGiftRequest();
...
//    EaseHelper.getInstance().register(mobile, "123456");
  ...
  public static void showStatisticsCount(View view, Statistics.Data statistics) {
    ...
    TextView mTvewFavoriteProduct = (TextView) view.findViewById(R.id.tvew_favorite_product_show);
    TextView mTvewFavoriteShop = (TextView) view.findViewById(R.id.tvew_favorite_shop_show);
    TextView mTvewFootprint = (TextView) view.findViewById(R.id.tvew_footprint_show);

    TextView mTvewPayTip = (TextView) view.findViewById(R.id.tvew_pay_tip_show);

    TextView mTvewDeliveryTip = (TextView) view.findViewById(R.id.tvew_delivery_tip_show);

    TextView mTvewReceiptTip = (TextView) view.findViewById(R.id.tvew_receipt_tip_show);

    TextView mTvewReviewTip = (TextView) view.findViewById(R.id.tvew_review_tip_show);

    TextView mTvewRefundTip = (TextView) view.findViewById(R.id.tvew_refund_tip_show);
    if (null == statistics) {
