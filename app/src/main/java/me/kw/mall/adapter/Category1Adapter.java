...
public class Category1Adapter extends CommonExpandabelAdapter {
  ...
  public View getGroupView(int groupPosition, boolean isExpanded,
    ...
    ProductCategory.CategoryItem category = (ProductCategory.CategoryItem) mList.get(groupPosition);
  ...
  public View getChildView(final int groupPosition, final int childPosition,
    ...
    LinearLayout llayoutBg = (LinearLayout) findViewById(convertView, R.id
        .llayout_category_bg_show);
    TextView tvewReviewTitle = (TextView) findViewById(convertView, R.id.tvew_review_title_show);
