...
public class CategoryRecomAdapter extends BaseAdapter {
  ...
  public CategoryRecomAdapter(Context mContext, List<AdProduct.AdItem> list) {
    ...
    options = ImageLoaderUtil.getDisplayImageOptions(com.android.component.zframework.R.drawable
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    if (null == convertView) {
      convertView = mInflater.inflate(R.layout.adapter_category_recom, null);
    }
