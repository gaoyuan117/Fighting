...
import me.kw.mall.enumerate.DistinguishStatus;
import me.kw.mall.model.DistinguishBusiness;
import service.api.DistinguishItem;
...
public class DistinguishOrderAdapter extends CommonAdapter {
  ...
  public View getView(final int position, View convertView, ViewGroup parent) {
    if (null == convertView) {
      convertView = layoutInflater.inflate(R.layout.adapter_distinguish_order, null);
    }
    ImageView imgvewPhoto = findViewById(convertView, R.id.imgvew_photo_show);
    TextView tvewOrderId = findViewById(convertView, R.id.tvew_order_id_show);
    ...
    TextView tvewProductNum = findViewById(convertView, R.id.tvew_product_num_show);
    TextView tvewOrderPay = findViewById(convertView, R.id.tvew_order_pay_show_click);

    TextView tvewAddShippment = findViewById(convertView, R.id.tvew_order_add_shippment_show_click);
    TextView tvewShippment = findViewById(convertView, R.id.tvew_order_shippment_show_click);
    TextView tvewDel = findViewById(convertView, R.id.tvew_order_del_show_click);
    ...
    mImageLoader.displayImage(Endpoint.HOST + item.image[0], imgvewPhoto, options);
    ...
    tvewAddShippment.setOnClickListener(new View.OnClickListener() {
...
//        intentToActivity(bundle, SubmitExpressActivity_.class);
    ...
    tvewShippment.setOnClickListener(new View.OnClickListener() {
...
//        intentToActivity(bundle, ExpressDetailActivity_.class);
    ...
    tvewOrderPay.setOnClickListener(new View.OnClickListener() {
