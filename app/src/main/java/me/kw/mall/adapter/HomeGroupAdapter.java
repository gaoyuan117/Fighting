...
public class HomeGroupAdapter extends CommonAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    if (null == convertView) {
      convertView = layoutInflater.inflate(R.layout.adapter_home_group, null);
    }
    //分类图片
    ImageView imgvewMark = findViewById(convertView, R.id.imgvew_group_image_show);
    TextView tvewReviewTitle = findViewById(convertView, R.id.tvew_group_name_show);
